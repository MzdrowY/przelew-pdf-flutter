...
class AppThemeColors extends ThemeExtension<AppThemeColors> {
  ...
  // Paleta oparta na Catppuccin Macchiato — sprawdzony, profesjonalny schemat.
  factory AppThemeColors.office() => const AppThemeColors(
        primary: Color(0xFF8AADF4),
        primarySoft: Color(0xFFB7BDF8),
        primaryGlow: Color(0xFF5B7DB4),
        accent: Color(0xFF8BD5CA),
        accentGlow: Color(0xFF6BB3A8),
        backgroundTop: Color(0xFF24273A),
        backgroundBottom: Color(0xFF1E2030),
        surface: Color(0xFF363A4F),
        surfaceElevated: Color(0xFF494D64),
        field: Color(0xFF303447),
        fieldFocused: Color(0xFF363A4F),
        textPrimary: Color(0xFFCAD3F5),
        textSecondary: Color(0xFFA5ADCB),
        textTertiary: Color(0xFF8087A2),
        textDisabled: Color(0xFF6E738D),
        border: Color(0xFF494D64),
        borderLight: Color(0xFF5B6078),
        borderGlow: Color(0xFF8AADF4),
        error: Color(0xFFED8796),
        warning: Color(0xFFEED49F),
        success: Color(0xFFA6DA95),
        shimmerBase: Color(0xFF303447),
        shimmerHighlight: Color(0xFF363A4F),
        sectionAccent: Color(0xFF494D64),
        useAurora: false,
        isDark: true,
      );
