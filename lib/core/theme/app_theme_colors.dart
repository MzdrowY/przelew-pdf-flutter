...
class AppThemeColors extends ThemeExtension<AppThemeColors> {
  ...
  factory AppThemeColors.office() => const AppThemeColors(
        primary: Color(0xFF5B54D9),
        primarySoft: Color(0xFF7C75FF),
        primaryGlow: Color(0xFF4A43C7),
        accent: Color(0xFF2A9D8F),
        accentGlow: Color(0xFF21897C),
        backgroundTop: Color(0xFFF5F6F8),
        backgroundBottom: Color(0xFFECEEF2),
        surface: Color(0xFFFFFFFF),
        surfaceElevated: Color(0xFFF8F9FB),
        field: Color(0xFFF1F2F5),
        fieldFocused: Color(0xFFE8EAEF),
        textPrimary: Color(0xFF2A2A35),
        textSecondary: Color(0xFF5A5A6E),
        textTertiary: Color(0xFF8A8A9A),
        textDisabled: Color(0xFFB0B0BE),
        border: Color(0xFFDADDE3),
        borderLight: Color(0xFFE5E7EC),
        borderGlow: Color(0xFF7C75FF),
        error: Color(0xFFD32F2F),
        warning: Color(0xFFF57C00),
        success: Color(0xFF388E3C),
        shimmerBase: Color(0xFFECEEF2),
        shimmerHighlight: Color(0xFFF5F6F8),
        sectionAccent: Color(0xFFE5E7EC),
        useAurora: false,
        isDark: false,
      );
