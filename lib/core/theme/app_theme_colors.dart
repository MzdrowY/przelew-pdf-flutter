...
class AppThemeColors extends ThemeExtension<AppThemeColors> {
  ...
  // Paleta oparta na Dracula — wysoki kontrast, nasycone akcenty, nie wyblakła.
  factory AppThemeColors.office() => const AppThemeColors(
        primary: Color(0xFFBD93F9),
        primarySoft: Color(0xFFD6B3FF),
        primaryGlow: Color(0xFF9A6FD6),
        accent: Color(0xFF8BE9FD),
        accentGlow: Color(0xFF6BC9DD),
        backgroundTop: Color(0xFF282A36),
        backgroundBottom: Color(0xFF21222C),
        surface: Color(0xFF44475A),
        surfaceElevated: Color(0xFF4D5266),
        field: Color(0xFF383A46),
        fieldFocused: Color(0xFF44475A),
        textPrimary: Color(0xFFF8F8F2),
        textSecondary: Color(0xFFBFBFBF),
        textTertiary: Color(0xFF6272A4),
        textDisabled: Color(0xFF4A4D5E),
        border: Color(0xFF44475A),
        borderLight: Color(0xFF4D5266),
        borderGlow: Color(0xFFBD93F9),
        error: Color(0xFFFF5555),
        warning: Color(0xFFFFB86C),
        success: Color(0xFF50FA7B),
        shimmerBase: Color(0xFF383A46),
        shimmerHighlight: Color(0xFF44475A),
        sectionAccent: Color(0xFF4D5266),
        useAurora: false,
        isDark: true,
      );
